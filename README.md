...
* [X] User can **compose and post a new tweet**
  * [X] User can click a “Compose” icon as Floating Action Button
...
* [X] Characters counter turns to red when tweet is larger than 280 characters.
* [X] Tweet button disables and changes of color when tweet is larger than 280 characters.
* [X] Each tweet shows number of likes and retweets. It shows the quantity in a short way ( 3M , 27K).
